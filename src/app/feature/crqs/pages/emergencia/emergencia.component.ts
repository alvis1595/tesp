...
export class EmergenciaComponent {
  ...
  constructor(private getChangeService: GetChangesService) {}
  ...
  consultardata(): void {
    ...
    this.getChangeService.get_arg_estados('emerg').subscribe((estados) => {
      this.getChangeService
        ...
        .subscribe((resultado) => {
          for (let i = 0; i < resultado.length; i++) {
            ...
            if (estados.includes(resultado[i].varRequestType)) {
