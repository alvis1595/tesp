      ...
      this.getChangeService
        ...
        .subscribe((resultado) => {
          ...
          this.listaDeCRM.forEach((element) => {
            ...
            // ============================================
            // MODIFICADO: Guardar URL limpia antes de convertir a HTML
            // ============================================
            let jfrogUrlLimpia = ''; // Variable para guardar la URL sin HTML
            ...
            if (element.varInfra.length > 10) {
              ...
              // ============================================
              // AGREGADO: Guardar la URL limpia ANTES de convertirla en HTML
              // ============================================
              jfrogUrlLimpia = element.varInfra.replace(baseUrl, newUrl);
              
              // Ahora sí, crear el HTML
              element.varInfra = `<a href='${jfrogUrlLimpia}' target='_blank'>${element.varCambio2}</a>`;
            }
            
            // ============================================
            // AGREGADO: Guardar la URL limpia en una nueva propiedad
            // ============================================
            element.varInfraUrl = jfrogUrlLimpia;
            ...
            children: [
              {
                ...
                // ============================================
                // MODIFICADO: Usar la URL limpia en lugar del HTML
                // Original: enlaceJfrog: element.varInfra
                // ============================================
                enlaceJfrog: element.varInfraUrl || '',
              },
            ],
          }));
